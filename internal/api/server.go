...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/tokens", s.mgmt.GetTokenPolicies)
		mgmt.POST("/tokens", s.mgmt.CreateTokenPolicy)
		mgmt.PATCH("/tokens/:id", s.mgmt.PatchTokenPolicy)
		mgmt.POST("/tokens/:id/rotate", s.mgmt.RotateTokenPolicy)
